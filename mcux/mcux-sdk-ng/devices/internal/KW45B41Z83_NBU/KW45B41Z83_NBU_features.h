...
#ifndef _KW45B41Z83_NBU_FEATURES_H_
#define _KW45B41Z83_NBU_FEATURES_H_
...
/* @brief Multiple flash block. */
#define FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH_BLOCK (0)
...
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_SECTOR_SIZE (0x2000U)
/* @brief P-Flash page size. */
#define FSL_FEATURE_FLASH_BLOCK_PAGE_SIZE (128)
/* @brief P-Flash phrase size. */
#define FSL_FEATURE_FLASH_BLOCK_PHRASE_SIZE (16)
...
#define FSL_FEATURE_FLASH_BLOCK0_IFR1_START (0x02100000U)
/* @brief flash block IFR0 size. */
#define FSL_FEATURE_IFR0_SIZE (0x8000U)
/* @brief flash block IFR1 size. */
#define FSL_FEATURE_IFR1_SIZE (0x2000U)
/* @brief IFR sector size. */
#define FSL_FEATURE_IFR_SECTOR_SIZE (0x2000U)
/* @brief IFR page size. */
#define FSL_FEATURE_IFR_PAGE_SIZE (128)
/* @brief P-Flash Erase/Read 1st block command address alignment. */
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_CMD_ADDRESS_ALIGMENT (0x100000U)
/* @brief P-Flash Erase sector command address alignment. */
#define FSL_FEATURE_FLASH_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT (8192)
/* @brief P-Flash program flash page commend address alignment. */
#define FSL_FEATURE_FLASH_PFLASH_PAGE_CMD_ADDRESS_ALIGMENT (128)
/* @brief P-Flash program flash phrase commend address alignment. */
#define FSL_FEATURE_FLASH_PFLASH_PHRASE_CMD_ADDRESS_ALIGMENT (16)
...
/* @brief Has core ldo vdd driver strength (register bit LP_CFG[CORELDO_VDD_DS]). */
...
/* @brief Set CORELDO_VDD_LVL to 0 then regulate to Under Drive Voltage 0.9v */
...
#endif /* _KW45B41Z83_NBU_FEATURES_H_ */
