...
#define SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY (64000000UL)
#endif
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_Atx0            = MAKE_MRCC_REGADDR(MRCC_BASE, 0x12C), /*!< Clock atx0 */
    kCLOCK_Mtr_master      = MAKE_MRCC_REGADDR(MRCC_BASE, 0x134), /*!< Clock mtr_master */
    kCLOCK_Bist            = MAKE_MRCC_REGADDR(MRCC_BASE, 0x400), /*!< Clock bist */
    ...
    kCLOCK_Romcp0          = MAKE_MRCC_REGADDR(MRCC_BASE, 0x418), /*!< Clock romcp0 */
    ...
    kCLOCK_Lptmr0_ipg_clk_erclk_wake2vsys =
        MAKE_MRCC_REGADDR(MRCC_BASE, 0x430), /*!< Clock Lptmr0_ipg_clk_erclk_wake2vsys */
    kCLOCK_Lptmr1_ipg_clk_erclk_wake2vsys =
        MAKE_MRCC_REGADDR(MRCC_BASE, 0x434), /*!< Clock kCLOCK_Lptmr1_ipg_clk_erclk_wake2vsys */
} clock_ip_name_t;
