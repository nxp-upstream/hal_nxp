...
typedef enum _clock_ip_control
{
    ...
    kCLOCK_IpClkControl_fun2 = MRCC_CC(2U), /*!< Peripherals clocks are enabled unless peripheral is idle, low power mode entry
                                      will stall until peripheral is idle. */
    kCLOCK_IpClkControl_fun3 =
        MRCC_CC(3U), /*!<  Peripheral clocks are enabled unless in SLEEP mode (or lower), low power mode entry will stall until
...
typedef enum _clock_ip_src
{
    ...
    kCLOCK_IpSrc1M      = 4U, /*!< 1MHZ is derived out of FRO6M. */
} clock_ip_src_t;
...
{
    kCLOCK_DivLPADC0       = (0x0A4U), /*!< ADC0         clock divider */
    kCLOCK_DivEWM0         = (0x10CU), /*!< EWM0         clock divider */
    kCLOCK_DivFLEXCAN0     = (0x134U), /*!< FLEXCAN0     clock divider */
    kCLOCK_DivFRO_HF_DIV   = (0x154U), /*!< FRO_HF_DIV   clock divider */
    kCLOCK_DivGDET_WRAPPER = (0x15CU), /*!< GDET_WRAPPER clock divider */
    kCLOCK_DivLPI2C0       = (0x194U), /*!< LPI2C0       clock divider */
    kCLOCK_DivLPI2C1       = (0x19CU), /*!< LPI2C1       clock divider */
    kCLOCK_DivLPIT0        = (0x1A4U), /*!< LPIT0        clock divider */
    kCLOCK_DivLPSPI0       = (0x1ACU), /*!< LPSPI0       clock divider */
    kCLOCK_DivLPSPI1       = (0x1B4U), /*!< LPSPI1       clock divider */
    kCLOCK_DivLPSPI2       = (0x1BCU), /*!< LPSPI2       clock divider */
    kCLOCK_DivLPTMR0       = (0x1C4U), /*!< LPTMR0       clock divider */
    kCLOCK_DivLPTMR1       = (0x1CCU), /*!< LPTMR1       clock divider */
    kCLOCK_DivLPUART0      = (0x1D4U), /*!< LPUART0      clock divider */
    kCLOCK_DivLPUART1      = (0x1DCU), /*!< LPUART1      clock divider */
    kCLOCK_DivTPM0         = (0x25CU), /*!< TPM0         clock divider */
    kCLOCK_DivTPM1         = (0x264U), /*!< TPM1         clock divider */
    kCLOCK_DivTPM2         = (0x26CU), /*!< TPM2         clock divider */
    kCLOCK_DivTPM3         = (0x274U), /*!< TPM3         clock divider */
    kCLOCK_DivTPM4         = (0x27CU), /*!< TPM4         clock divider */
    kCLOCK_DivWDG0         = (0x2A4U), /*!< WDG0         clock divider */
    kCLOCK_DivWDG1         = (0x2ACU), /*!< WDG1         clock divider */
    kCLOCK_DivMax          = (0x2ACU), /*!< MAX          clock divider */
} clock_div_name_t;
