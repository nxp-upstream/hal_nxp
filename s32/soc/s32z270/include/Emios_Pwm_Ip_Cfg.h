...
==================================================================================================*/
    ...
    /* Check if header file and Emios_Pwm_Ip_Init_PBcfg header file are of the same AUTOSAR version */
    ...
    /* Check if header file and Emios_Pwm_Ip_Init_PBcfg header file are of the same software version */
...
#define EMIOS_PWM_IP_MODES                         (8U)
/** @brief      Mapping between available channels and the PWM mode supported by each of them */
#define EMIOS_PWM_IP_CHANNEL_MODES                 {\
                                                    {0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL},\
                                                    {0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL, 0xFFFF00FFUL},\
                                                }
