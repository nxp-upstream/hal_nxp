...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h ""
	RTE_Device.KW45B41Z83)
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template/SEGGER_RTT_Conf.h ${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template driver_rtt_template.KW45B41Z83)
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
	${CMAKE_CURRENT_LIST_DIR}/../MCXW716C/drivers/fsl_clock.c
)

target_include_directories(${MCUX_SDK_PROJECT_NAME} PUBLIC
	${CMAKE_CURRENT_LIST_DIR}/../MCXW716C/drivers/.
)
...
if(CONFIG_USE_component_mflash_common AND (CONFIG_BOARD STREQUAL kw45b41zevk) AND CONFIG_USE_driver_mcm AND CONFIG_USE_driver_flash_k4)
...
message(SEND_ERROR "component_mflash_mcxw716.KW45B41Z83 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_BOARD STREQUAL kw45b41zevk) AND (CONFIG_USE_driver_flash_k4 OR CONFIG_USE_driver_romapi))
...
if((CONFIG_USE_driver_common AND CONFIG_USE_middleware_baremetal AND CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_kw45b41zevk) OR (CONFIG_USE_driver_common AND CONFIG_USE_middleware_freertos-kernel AND CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config_kw45b41zevk) OR (CONFIG_USE_driver_common AND CONFIG_USE_middleware_multicore_rpmsg_lite_kw45b41zevk_nbu_threadx) OR (CONFIG_USE_middleware_wireless_framework_rpmsg_config AND (CONFIG_BOARD STREQUAL kw45b41zevk)))
...
if (CONFIG_USE_component_power_manager_kw45b41zevk)
# Add set(CONFIG_USE_component_power_manager_kw45b41zevk true) in config.cmake to use this component

message("component_power_manager_kw45b41zevk component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_power_manager_kw45b41zevk.KW45B41Z83 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
	${CMAKE_CURRENT_LIST_DIR}/../MCXW716C/drivers/fsl_romapi.c
)
...
message(SEND_ERROR "driver_rtt.KW45B41Z83 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
